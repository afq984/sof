...
void platform_init_memmap(struct sof *sof)
{
	...
	sof->memory_map->system[0].heap = (uintptr_t)0x1000;
	...
	sof->memory_map->runtime_shared[0].heap =
			cache_to_uncache((uintptr_t)0x1000);
	...
	/* .system_shared init */
	sof->memory_map->system_shared[0].heap = cache_to_uncache((uintptr_t)0x1000);
	...
	sof->memory_map->runtime[0].heap = (uintptr_t)0x1000;
	...
	sof->memory_map->buffer[0].heap = (uintptr_t)0x1000;
